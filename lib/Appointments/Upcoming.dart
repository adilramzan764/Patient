import 'package:calne_heatlh_care1/Appointments/AppointmentDetails.dart';
            ...
            return GestureDetector(
              onTap: (){
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => Appointment_Details(), // Replace MyNewScreen with your desired screen widget
                  ),
                );
              },
              child: Padding(
                        ...
                        Row(
                          children: [
                            ...
                            Container(
                              ...
                              child: designations[index] == 'Video Consult'
                                  ? Align(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Text(designations[index],style: TextStyle(fontSize: 13,color: Colors.black87),),
                                      SizedBox(width: 15,),
                                      Container(
                                        height: 29,
                                        width: 80,
